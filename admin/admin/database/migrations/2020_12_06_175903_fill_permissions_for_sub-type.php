...
class FillPermissionsForSubType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSubType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.sub-type',
            'admin.sub-type.index',
            'admin.sub-type.create',
            'admin.sub-type.show',
            'admin.sub-type.edit',
            'admin.sub-type.delete',
            'admin.sub-type.bulk-delete',
        ]);
