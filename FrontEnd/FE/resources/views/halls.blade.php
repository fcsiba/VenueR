...
<html lang="en">
  ...
  <div class="site-section site-section-sm pb-0">
    <div class="container">
        <div class="row">
            <form class="form-search col-md-12" method="post" action="{{ url('/halls_search') }}"  style="margin-top: -100px;">
                {{ csrf_field() }}
      ...
      <div class="row mb-5">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="property-entry h-100">
            <a href="{{url('/halls/detail/'.$item->id)}}" class="property-thumbnail">
            ...
            <div class="p-4 property-body">
              ...
              <h2 class="property-title"><a href="property-details2.html">{{$item->name}}</a></h2>
              <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span> {{$item->address}} </span>
              <strong class="property-price text-primary mb-3 d-block text-success">{{$item->subtype->name}}</strong>
