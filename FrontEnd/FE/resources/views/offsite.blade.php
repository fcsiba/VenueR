...
<body>
    ...
    <div class="slide-one-item home-slider owl-carousel">
        ...
        <div class="site-blocks-cover overlay" style="background-image: url(images/CS/offsite\ cover.jpg);"
                ...
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-md-10">
                        ...
                        <p class="mb-5"><strong class="h5">
                                ...
                                <p>Find the perfect rooms for offsite meetings in the most urgent times for most
                                    reasonable prices, daily or hourly.
                            </strong></p>
    ...
    <div class="site-section site-section-sm pb-0">
        <div class="container">
            <div class="row">
                <form class="form-search col-md-12" method="post" action="{{ url('/offsite_search') }}"  style="margin-top: -100px;">
                    {{ csrf_field() }}
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="property-entry h-100">
                        <a href="{{url('/offsite/detail/'.$item->id)}}" class="property-thumbnail">
                        ...
                        <div class="p-4 property-body">
                            ...
                            <h2 class="property-title"><a
                                    href="{{url('/offsite/detail/'.$item->id)}}">{{$item->name}}</a></h2>
