...
<body>
    ...
    <div class="slide-one-item home-slider owl-carousel">
        ...
        <div class="site-blocks-cover overlay" style="background-image: url(images/PG/badminton1.jpg);" data-aos="fade"
            data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-md-10">
                        <!--<span class="d-inline-block bg-success text-white px-3 mb-3 property-offer-type rounded">For Rent</span> -->
                        <h1 class="mb-2">Play grounds</h1>
                        <p class="mb-5"><strong class="h5">
                                <p>Any type of sports can be conducted with saving time as the solution to ground
                                    searching is VenueR
                            </strong></p>
        ...
        <div class="site-blocks-cover overlay" style="background-image: url(images/PG/1.jpeg);" data-aos="fade"
            data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-md-10">
    ...
    <div class="site-section site-section-sm pb-0">
        <div class="container">
            <div class="row">
                <form class="form-search col-md-12" method="post" action="{{ url('/playground_search') }}"  style="margin-top: -100px;">
                    {{ csrf_field() }}
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="property-entry h-100">
                        <a href="{{url('/playground/detail/'.$item->id)}}" class="property-thumbnail">
                        ...
                        <div class="p-4 property-body">
                            ...
                            <h2 class="property-title"><a
                                    href="{{url('/playground/detail/'.$item->id)}}">{{$item->name}}</a></h2>
