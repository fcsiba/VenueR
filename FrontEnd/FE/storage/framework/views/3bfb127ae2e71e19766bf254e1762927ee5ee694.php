                ...
                <div class="row mb-5">
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-100">
                            <a href="<?php echo e(url('/meeting')); ?>" class="property-thumbnail">
                            ...
                            <div class="p-4 property-body">
                                ...
                                <h2 class="property-title"><a href="<?php echo e(url('/meeting')); ?>">Meeting Rooms</a></h2>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-100">
                            <a href="<?php echo e(url('/parties')); ?>" class="property-thumbnail">
                                <div class="offer-type-wrap">
                                </div>
                            ...
                            <div class="p-4 property-body">
                                <a href="#" class="property-favorite "><span class="icon-heart-o"></span></a>
                                <h2 class="property-title"><a href="<?php echo e(url('/parties')); ?>">Private Dinings</a></h2>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-80">
                            <a href="<?php echo e(url('/playground')); ?>" class="property-thumbnail">
                                <div class="offer-type-wrap">
                                </div>
                            ...
                            <div class="p-4 property-body">
                                <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                                <h2 class="property-title"><a href="<?php echo e(url('/playgrounds')); ?>"> Football Ground</a></h2>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-80">
                            <a href="<?php echo e(url('/wedding')); ?>" class="property-thumbnail">
                                <div class="offer-type-wrap">
                                </div>
                            ...
                            <div class="p-4 property-body">
                                <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                                <h2 class="property-title"><a href="<?php echo e(url('/wedding')); ?>">Weddings</a></h2>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-80">
                            <a href="<?php echo e(url('/unusual')); ?>" class="property-thumbnail">
                                <div class="offer-type-wrap"> </div>
                                <img src="images/others/1.jpeg" alt="Image" class="img-fluid">
                            </a>
                            <div class="p-4 property-body">
                                <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                                <h2 class="property-title"><a href="<?php echo e(url('/unusual')); ?>"> The Unusuals </a></h2>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-80">
                            <a href="<?php echo e(url('/professional')); ?>" class="property-thumbnail">
                                <div class="offer-type-wrap">
                                </div>
                            ...
                            <div class="p-4 property-body">
                                <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                                <h2 class="property-title"><a href="<?php echo e(url('/professional')); ?>">Professional Spaces</a>
                                </h2>
            ...
            <div class="container">
                ...
                <div class="col-md-10">
                  <div class="property-entry horizontal d-lg-flex">
                    ...
                    <a href="<?php echo e(url('/meeting')); ?>" class="property-thumbnail h-500">
                      <div class="offer-type-wrap">
              ...
              <div class="row mb-2">
                <div class="col-md-10">
                  <div class="property-entry horizontal d-lg-flex">
                    ...
                    <a href="<?php echo e(url('/parties')); ?>" class="property-thumbnail h-100">
                      <div class="offer-type-wrap">
              ...
              <div class="row mb-2">
                <div class="col-md-10">
                  <div class="property-entry horizontal d-lg-flex">
                    ...
                    <a href="<?php echo e(url('/playground')); ?>" class="property-thumbnail h-100">
                      <div class="offer-type-wrap">
                    ...
                    <div class="p-4 property-body">
                      <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                      <h2 class="property-title"><a href="<?php echo e(url('/playground')); ?>"> Football Ground</a></h2>
                      <span class=""></span> Type <strong> Play Ground </strong> </span>
              ...
              <div class="row mb-2">
                <div class="col-md-10">
                  <div class="property-entry horizontal d-lg-flex">
                    ...
                    <a href="<?php echo e(url('/wedding')); ?>" class="property-thumbnail h-100">
                      <div class="offer-type-wrap">
              ...
              <div class="row mb-2">
                <div class="col-md-10">
                  <div class="property-entry horizontal d-lg-flex">
                    ...
                    <a href="<?php echo e(url('/unusual')); ?>" class="property-thumbnail h-100">
                      <div class="offer-type-wrap">
                    ...
                    <div class="p-4 property-body">
                      <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                      <h2 class="property-title"><a href="<?php echo e(url('/unusual')); ?>">The Unusual</a></h2>
                      <span class=""></span> Type <strong> Other Spaces </strong> </span>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <p><a class="btn btn-primary btn-wide btn-large explorebtn"
                                                                    href="<?php echo e(url('/safeevent')); ?>" tabindex="-1">Find Out
                                                                    More</a></p>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php /**PATH /home2/callingdeskcom/public_html/fyp/fyp/resources/views/index.blade.php ENDPATH**/ ?>