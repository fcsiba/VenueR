...
<body>
    ...
    <div class="slide-one-item home-slider owl-carousel">
        ...
        <div class="site-blocks-cover overlay" style="background-image: url(images/GS/1.jpeg);" data-aos="fade"
        ...
        <div class="site-blocks-cover overlay" style="background-image: url(images/GS/wedd.JPG);" data-aos="fade"
            data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-md-10">
    ...
    <div class="site-section site-section-sm pb-0">
        <div class="container">
            <div class="row">
                <form class="form-search col-md-12" method="post" action="<?php echo e(url('/wedding_search')); ?>"  style="margin-top: -100px;">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="property-entry h-100">
                        <a href="<?php echo e(url('/wedding/detail/'.$item->id)); ?>" class="property-thumbnail">
                            <div class="offer-type-wrap">
                            </div>
                            <img src="images/GS/<?php echo e($item->image); ?>" alt="Image" class="img-fluid">
                        </a>
                        <div class="p-4 property-body">
                            <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                            <h2 class="property-title"><a
                                    href="<?php echo e(url('/wedding/detail/'.$item->id)); ?>"><?php echo e($item->name); ?></a></h2>
                            ...
                            <ul class="property-specs-wrap mb-3 mb-lg-0">
                                ...
                                <li>
                                    <span class="property-specs">Price/Rs</span>
...
<?php /**PATH C:\xampp\htdocs\fyp\resources\views/weddings.blade.php ENDPATH**/ ?>