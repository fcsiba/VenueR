...
<html lang="en">
  ...
  <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            ...
            <h1 class="mb-2">Wedding halls</h1>
            <p class="mb-5"><strong class="h5">
            <p> Get your most special day the most suitable wedding hall with plenty of options on VenueR   </strong></p>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/halls/cover.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
  ...
  <div class="site-section site-section-sm pb-0">
    <div class="container">
        <div class="row">
            <form class="form-search col-md-12" method="post" action="<?php echo e(url('/halls_search')); ?>"  style="margin-top: -100px;">
      ...
      <div class="row mb-5">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="property-entry h-100">
            <a href="<?php echo e(url('/halls/detail/'.$item->id)); ?>" class="property-thumbnail">
            ...
            <div class="p-4 property-body">
              ...
              <h2 class="property-title"><a href="property-details2.html"><?php echo e($item->name); ?></a></h2>
              <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span> <?php echo e($item->address); ?> </span>
              <strong class="property-price text-primary mb-3 d-block text-success"><?php echo e($item->subtype->name); ?></strong>
...
</html><?php /**PATH /home2/callingdeskcom/public_html/fyp/fyp/resources/views/halls.blade.php ENDPATH**/ ?>