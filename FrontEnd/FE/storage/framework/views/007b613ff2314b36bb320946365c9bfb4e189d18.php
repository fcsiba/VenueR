...
<html lang="en">
  ...
  <div class="slide-one-item home-slider owl-carousel">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(<?php echo e(asset('images/CS/offsite\ cover.jpg')); ?>);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            <!--<span class="d-inline-block bg-success text-white px-3 mb-3 property-offer-type rounded">For Rent</span> -->
            <h1 class="mb-2">Offsite Meetings </h1>
            <p class="mb-5"><strong class="h5">
            
            <p>Find the perfect rooms for offsite meetings in the most urgent times for most reasonable prices, daily or hourly.   </strong></p>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(<?php echo e(asset('images/outdoor\ 1.JPG')); ?>);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <div>
            <div class="slide-one-item home-slider owl-carousel">
              <div><img src="http://callingdesk.com.pk/venueadmin/adminfyp/storage/app/public/img/<?php echo e($venue->image); ?>" alt="Image" class="img-fluid"></div>
          ...
          <div class="bg-white property-body border-bottom border-left border-right">
            ...
            <div class="row mb-5">
              <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                ...
                <strong class="d-block"><?php echo e($venue->types->name); ?></strong>
              </div>
              <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
              ...
              <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                <span class="d-inline-block text-black mb-0 caption-text">Price/Hr</span>
        ...
        <div class="col-lg-4">
          ...
          <div class="bg-white widget border rounded">
            ...
            <form method="POST" action="" class="form-contact-agent" id="contact_us">
              ...
              <input type="hidden" value="<?php echo e($venue->admin_id); ?>" name="admin_id">
              <div class="form-group">
...
</html><?php /**PATH /home2/callingdeskcom/public_html/fyp/fyp/resources/views/detail-offsite.blade.php ENDPATH**/ ?>