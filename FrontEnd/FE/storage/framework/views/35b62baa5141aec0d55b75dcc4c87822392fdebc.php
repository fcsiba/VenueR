...
<body>
    ...
    <div class="slide-one-item home-slider owl-carousel">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-md-10">
                        ...
                        <h1 class="mb-2">Meeting Rooms</h1>
                        <p class="mb-5"><strong class="h5">
                                <p>Find in the most urgent times for most reasonable prices the perfect meeting rooms.
                            </strong></p>
        ...
        <div class="site-blocks-cover overlay" style="background-image: url(images/outdoor\ 1.JPG);" data-aos="fade"
    ...
    <div class="site-section site-section-sm pb-0">
        <div class="container">
            <div class="row">
                <form class="form-search col-md-12" method="post" action="<?php echo e(url('/meeting_search')); ?>"  style="margin-top: -100px;">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="property-entry h-100">
                        <a href="<?php echo e(url('/meeting/detail/'.$item->id)); ?>" class="property-thumbnail">
                            <div class="offer-type-wrap">
                            </div>
                            <img src="images/CS/<?php echo e($item->image); ?>" alt="Image" class="img-fluid">
                        </a>
                        <div class="p-4 property-body">
                            <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                            <h2 class="property-title"><a
                                    href="<?php echo e(url('/meeting/detail/'.$item->id)); ?>"><?php echo e($item->name); ?></a></h2>
...
<?php /**PATH C:\xampp\htdocs\fyp\resources\views/meeting.blade.php ENDPATH**/ ?>