...
<html lang="en">
  ...
  <div class="slide-one-item home-slider owl-carousel">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(<?php echo e(asset('images/TC/training\ cover.webp')); ?>);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
              <h1 class="mb-2">Training and courses </h1>
              <p class="mb-5"><strong class="h5">
              <p>Gather to impart knowledge and teach skills in places available for rtraining.    </strong></p>
            </div>
          </div>
        </div>
      </div>  
  
      <div class="site-blocks-cover overlay" style="background-image: url(<?php echo e(asset('images/TC/training-room-e1416959826401.jpg')); ?>);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
...
</html><?php /**PATH /home2/callingdeskcom/public_html/fyp/fyp/resources/views/detail-training.blade.php ENDPATH**/ ?>