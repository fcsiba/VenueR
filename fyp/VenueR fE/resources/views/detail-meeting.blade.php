...
<html lang="en">
  ...
  <div class="slide-one-item home-slider owl-carousel">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url({{asset('images/CS/meeting\ cover.png')}});" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            ...
            <p>Find in the most urgent times for most reasonable prices the perfect meeting rooms.   </strong></p>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url({{asset('images/outdoor\ 1.JPG')}});" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            ...
            <h1 class="mb-2">Meeting Rooms</h1>
            <p class="mb-5"><strong class="h5">
              <p>Find in the most urgent times for most reasonable prices the perfect meeting rooms.</h2></strong></p>
          </div>
        </div>
      </div>
    </div>  
