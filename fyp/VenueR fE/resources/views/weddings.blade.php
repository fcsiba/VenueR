...
<body>
    ...
    <div class="site-section site-section-sm pb-0">
        <div class="container">
            <div class="row">
                <form class="form-search col-md-12" method="post" action="{{ url('/wedding_search') }}"  style="margin-top: -100px;">
                    {{ csrf_field() }}
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="property-entry h-100">
                        <a href="{{url('/wedding/detail/'.$item->id)}}" class="property-thumbnail">
                        ...
                        <div class="p-4 property-body">
                            ...
                            <h2 class="property-title"><a
                                    href="{{url('/wedding/detail/'.$item->id)}}">{{$item->name}}</a></h2>
