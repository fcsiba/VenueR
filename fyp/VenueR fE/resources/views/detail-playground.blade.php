...
<html lang="en">
  ...
  <div class="slide-one-item home-slider owl-carousel">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url({{asset('images/PG/badminton1.jpg')}});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
              ...
              <p>Any type of sports can be conducted with saving time as the solution to ground searching is VenueR   </strong></p>
      ...
      <div class="site-blocks-cover overlay" style="background-image: url({{asset('images/PG/1.jpeg')}});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
