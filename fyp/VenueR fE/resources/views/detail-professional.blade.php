...
<html lang="en">
  ...
  <div class="slide-one-item home-slider owl-carousel">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url({{asset('images/PS/cover.jpg')}});" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            ...
            <p class="mb-5"><strong class="h5">
              <p>  Professional setups are just a click away. Setups include different shoot locations, music composition room and much more</strong></p>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url({{asset('images/PS/cover\ 1.jpg')}});" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
