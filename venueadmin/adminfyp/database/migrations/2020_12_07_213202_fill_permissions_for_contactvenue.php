...
class FillPermissionsForContactvenue extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForContactvenue constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.contactvenue',
            'admin.contactvenue.index',
            'admin.contactvenue.create',
            'admin.contactvenue.show',
            'admin.contactvenue.edit',
            'admin.contactvenue.delete',
            'admin.contactvenue.bulk-delete',
        ]);
